...
{
    [TestClass]
    public class UTCartaoCreditoHomologacao
    {
        /// <summary>
        /// Para obter sucesso neste teste, por favor, subir - localmente - a API do ZAR.
        /// </summary>
        ...
        private readonly string ServicoApiDesenvolvimento = "https://localhost:44377/";
        #endregion
        ...
        public void InicializarParametrosTeste()
        {
            ...
            {
                ClienteDesenvolvimento = new HttpClient { BaseAddress = new Uri(ServicoApiDesenvolvimento) };
